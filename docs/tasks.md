...
- [~] 234 Remove dead parser and runtime contract paths -> tasks/234-remove-dead-parser-and-runtime-contract-paths.md
...
- [x] 231 Reuse evidence-path root identity -> tasks/done/231-reuse-evidence-path-root-identity.md
