...
- [ ] 539 Reduce session pre-hook allocations without weakening cache identity -> tasks/539-reduce-session-pre-hook-allocations-without-weakening-cache-identity.md
