...
| `codex` | `cli` | codex-session-start, codex-user-prompt-submit, codex-pre-tool-use, codex-permission-request, codex-post-tool-use, codex-mcp-before, codex-mcp-after, codex-stop, codex-interrupt, codex-session-end, codex-subagent-start, codex-subagent-stop, codex-pre-compaction, codex-post-compaction, codex-compaction-recovery | documented | Start codex in the disposable repository and exercise its documented positive, negative, compaction, and Stop routes. |
| `cursor` | `cursor-cli-interactive` | cursor-session-start, cursor-user-prompt-submit, cursor-pre-tool-use, cursor-before-shell-execution, cursor-post-tool-use, cursor-after-file-edit, cursor-post-tool-use-failure, cursor-after-shell-execution, cursor-stop, cursor-session-end, cursor-workspace-open | documented | Start cursor in the disposable repository and exercise its documented positive, negative, compaction, and Stop routes. |
| `cursor` | `cursor-cli-print` | cursor-session-start, cursor-user-prompt-submit, cursor-pre-tool-use, cursor-before-shell-execution, cursor-post-tool-use, cursor-after-file-edit, cursor-post-tool-use-failure, cursor-after-shell-execution, cursor-before-mcp-execution, cursor-after-mcp-execution, cursor-stop, cursor-session-end, cursor-workspace-open | documented | Start cursor in the disposable repository and exercise its documented positive, negative, compaction, and Stop routes. |
...
| `dsh` | `cli` | dsh-session-start, dsh-pre-tool-use, dsh-post-tool-use, dsh-post-tool-use-failure, dsh-stop | documented | Start DSH from the disposable repository with npx --yes @deepseek-ai/dsh@0.1.5-rc.2 --profile headless --patch .dsh/reconc.patch.yml and exercise the native pre-tool guard and final-result observations. |
...
| `global-lifecycle` | `v1` | reconc.global-lifecycle/v1 | `legacy` | <https://raw.githubusercontent.com/Christopher-Schulze/reconc/reconc-v0.9.6/schemas/v1/global-lifecycle.schema.json> | `schemas/v1/global-lifecycle.schema.json` |
| `global-lifecycle` | `v2` | reconc.global-lifecycle/v2 | `current` | <urn:reconc:schema:global-lifecycle:v2:sha256:4b0b882eaa20dd814bb1f7ef22e27425471f5b907bbedb26668a86b4f902b261> | `schemas/v2/global-lifecycle.schema.json` |
...
| `installation-receipt` | `v1` | 1 | `legacy` | <https://raw.githubusercontent.com/Christopher-Schulze/reconc/reconc-v0.9.6/schemas/v1/installation-receipt.schema.json> | `schemas/v1/installation-receipt.schema.json` |
| `installation-receipt` | `v2` | 2 | `current` | <urn:reconc:schema:installation-receipt:v2:sha256:2a5259b3820e737b64ddbf77cbe57be2b904d1924a114fcb67ba0726a94c002d> | `schemas/v2/installation-receipt.schema.json` |
