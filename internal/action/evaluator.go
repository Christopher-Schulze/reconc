...
// exact cache binding. Cache lookup, evaluation, and store can therefore share
// one normalization and identity derivation.
...
func verifyResampledIdentitiesExpected(actual, expected IdentitySnapshot) ReasonCode {
