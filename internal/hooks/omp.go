...
func generateOMP() (*Artifact, error) {
	routeBudgets, err := bunRouteBudgets(KindOMP)
	if err != nil {
		return nil, err
	}
...
const ompExtensionTemplate = `// Managed by reconc. Project-local Oh My Pi policy extension.
