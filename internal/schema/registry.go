...
func contracts() []Contract {
	return []Contract{
		...
		contract(PolicyConfig, "2", nil, "schemas/v2/policy-config.schema.json", "policy-config.schema.json", PolicyConfigURL, CurrentSchemaTag, "e5856413af32bea5f8b0fc108b3e5dcdfc84faf9d5e7e09bada79e7bdb5cad03", StateCurrent, misbound("schemas/v1/policy-config.schema.json")),
		...
		contract(PolicyLock, "4", []string{"4"}, "schemas/v4/policy-lock.schema.json", "policy-lock.schema.json", PolicyLockURL, "reconc-v0.9.4", "32f16bde36b7e8e5d0671c1e3f8bcbf35f810ad7699d93291d1ebb29831b3450", StateCurrent),
...
func observations() []Observation {
	return []Observation{
		...
		observation("schemas/v4/policy-lock.schema.json", PolicyLockURL, "reconc-v0.9.4", "32f16bde36b7e8e5d0671c1e3f8bcbf35f810ad7699d93291d1ebb29831b3450", CompatibilityByteIdentical),
	}
}
