...
func contracts() []Contract {
	return []Contract{
		...
		contract(PolicyConfig, "3", nil, "schemas/v3/policy-config.schema.json", "policy-config.schema.json", PolicyConfigURL, CurrentSchemaTag, "194e00de2e112680f3cf683e18b679a6bd926ef6fad8cdebb49b38379784fef8", StateCurrent),
		...
		contract(PolicyLock, "5", []string{"5"}, "schemas/v5/policy-lock.schema.json", "policy-lock.schema.json", PolicyLockURL, CurrentSchemaTag, "86838b49f01d254f0d6fc652105304fbd653c12b8f51a32674013d6bfa87c8f9", StateCurrent),
