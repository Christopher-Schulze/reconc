...
func contracts() []Contract {
	return []Contract{
		...
		contract(PolicyLock, "6", []string{"6"}, "schemas/v6/policy-lock.schema.json", "policy-lock.schema.json", PolicyLockURL, CurrentSchemaTag, "e8ea8dbe50ee1e971066968946a03ed27ffba73e86c2e5e7d2ce225fea2cecf7", StateCurrent, Alias{URL: PreviousPolicyLockV6URL, Reason: AliasPriorPublication}, Alias{URL: PolicyLockV6URLV097, Reason: AliasPriorPublication}),
