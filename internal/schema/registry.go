...
func contracts() []Contract {
	return []Contract{
		...
		contract(CustomRuntimeManifest, "1", []string{"reconc-custom-runtime/v1"}, "schemas/v1/custom-runtime-manifest.schema.json", "custom-runtime-manifest-v1.schema.json", DefaultBaseURL+"/custom-runtime-manifest.schema.json", CurrentSchemaTag, "58d55b01f2aeb4d0a63f7512df338fd94be494e581f64bc24e14213bdf4b6fd0", StateLegacy, unreachable("https://reconc.dev/schemas/custom-runtime-manifest/v1")),
		contract(CustomRuntimeManifest, "2", []string{"reconc-custom-runtime/v2"}, "schemas/v2/custom-runtime-manifest.schema.json", "custom-runtime-manifest.schema.json", CustomRuntimeManifestURL, CurrentSchemaTag, "fb32c2cd624f7c26c0b02699cdd938ca2c51e5caea48b6732c1a47882668b773", StateCurrent),
		contract(GlobalDiagnostic, "1", []string{"reconc.global-diagnostic/v1"}, "schemas/v1/global-diagnostic.schema.json", "global-diagnostic.schema.json", GlobalDiagnosticURL, CurrentSchemaTag, "2e6ef698e59e1df7b18107d3e2d8b57d947f3fff64175b188158ea081e7e8cd7", StateCurrent, misbound("schemas/v1/global-diagnostic.schema.json"), unpinned("schemas/v1/global-diagnostic.schema.json")),
		contract(GlobalLifecycle, "1", []string{"reconc.global-lifecycle/v1"}, "schemas/v1/global-lifecycle.schema.json", "global-lifecycle.schema.json", GlobalLifecycleURL, CurrentSchemaTag, "cc422e2e78ebaf3ea94dcef15ce09acef4bca0e2bd2e9fe0d130925b1e0bc341", StateCurrent, misbound("schemas/v1/global-lifecycle.schema.json"), unpinned("schemas/v1/global-lifecycle.schema.json")),
		contract(HarnessPackManifest, "1", []string{"reconc.harness-pack/v1"}, "schemas/v1/harness-pack-manifest.schema.json", "harness-pack-manifest.schema.json", HarnessPackManifestURL, CurrentSchemaTag, "b902a974a2ff488ed275adc3b6e07895be88ccb6ec19d49f4d366cf760cdbb24", StateCurrent, misbound("schemas/v1/harness-pack-manifest.schema.json"), unpinned("schemas/v1/harness-pack-manifest.schema.json")),
		contract(InstallationReceipt, "1", []string{"1"}, "schemas/v1/installation-receipt.schema.json", "installation-receipt.schema.json", InstallationReceiptURL, CurrentSchemaTag, "de380599f45e979381cdf9957a611d33b96c6d0ddb0d4fcea35c72e0c98e568c", StateCurrent, misbound("schemas/v1/installation-receipt.schema.json"), unpinned("schemas/v1/installation-receipt.schema.json")),
		contract(NeutralHookRequest, "1", []string{"reconc-neutral-hook-request/v1"}, "schemas/v1/neutral-hook-request.schema.json", "neutral-hook-request.schema.json", NeutralHookRequestURL, CurrentSchemaTag, "521133dd1e6e9d5dc76092fda320a41016e8e009b9ca77d9fbc9638a318f877e", StateCurrent, unreachable("https://reconc.dev/schemas/neutral-hook-request/v1")),
		contract(NeutralHookResponse, "1", []string{"reconc-neutral-hook-response/v1"}, "schemas/v1/neutral-hook-response.schema.json", "neutral-hook-response.schema.json", NeutralHookResponseURL, CurrentSchemaTag, "6271d3d728edeb372f0de921f02aa7ed0e3681a796dcd622848352ea5404e7b3", StateCurrent, unreachable("https://reconc.dev/schemas/neutral-hook-response/v1")),
		contract(PolicyConfig, "1", nil, "schemas/v1/policy-config.schema.json", "policy-config-v1.schema.json", DefaultBaseURL+"/policy-config.schema.json", CurrentSchemaTag, "7904398abf27b06418a51048926526786755a89132268ec25f7ecf398e6f68b1", StateLegacy, unpinned("schemas/v1/policy-config.schema.json")),
		contract(PolicyConfig, "2", nil, "schemas/v2/policy-config.schema.json", "policy-config-v2.schema.json", Version2BaseURL+"/policy-config.schema.json", CurrentSchemaTag, "e5856413af32bea5f8b0fc108b3e5dcdfc84faf9d5e7e09bada79e7bdb5cad03", StateLegacy, misbound("schemas/v1/policy-config.schema.json")),
		contract(PolicyConfig, "3", nil, "schemas/v3/policy-config.schema.json", "policy-config-v3.schema.json", Version3BaseURL+"/policy-config.schema.json", CurrentSchemaTag, "194e00de2e112680f3cf683e18b679a6bd926ef6fad8cdebb49b38379784fef8", StateLegacy),
		contract(PolicyConfig, "4", nil, "schemas/v4/policy-config.schema.json", "policy-config.schema.json", PolicyConfigURL, CurrentSchemaTag, "fe87ab8b32ece847df6974cbacdcac3ca9aafac85c04d028928ea4f5e91b4b0f", StateCurrent),
		contract(PolicyFixPlan, "1", []string{"1"}, "schemas/v1/policy-fix-plan.schema.json", "policy-fix-plan.schema.json", PolicyFixPlanURL, CurrentSchemaTag, "79e352562cadcf1fc84dbd438dfc9e884c3eb3d3a5b2db6aeb581bda1c9e99c1", StateCurrent, misbound("schemas/v1/policy-fix-plan.schema.json"), unpinned("schemas/v1/policy-fix-plan.schema.json")),
		contract(PolicyLock, "1", []string{"1"}, "schemas/v1/policy-lock.schema.json", "policy-lock-v1.schema.json", LegacyPolicyLockURL, CurrentSchemaTag, "58215033576329d41d2d80fd3c8f8d7c43a54571f9b14f18ec7040225667e325", StateLegacy, Alias{URL: LegacyPolicyLockURLV091, Reason: AliasMisboundReleaseTag}, Alias{URL: LegacyPolicyLockURLUnpinned, Reason: AliasUnpinnedLegacy}),
		contract(PolicyLock, "2", []string{"2"}, "schemas/v2/policy-lock.schema.json", "policy-lock-v2.schema.json", LegacyPolicyLockV2URL, CurrentSchemaTag, "b1bcbd2c7b1ae25a6e8e26aaa40ea39ce83cfe23daea5b62007c34e55ea355c7", StateLegacy, Alias{URL: LegacyPolicyLockV2URLV091, Reason: AliasMisboundReleaseTag}, Alias{URL: LegacyPolicyLockV2URLUnpinned, Reason: AliasUnpinnedLegacy}),
		contract(PolicyLock, "3", []string{"3"}, "schemas/v3/policy-lock.schema.json", "policy-lock-v3.schema.json", LegacyPolicyLockV3URL, CurrentSchemaTag, "71f098011740601759e93193217e875bae5861859e8bf25102530e37b833d099", StateLegacy, Alias{URL: LegacyPolicyLockV3URLV091, Reason: AliasMisboundReleaseTag}, Alias{URL: LegacyPolicyLockV3URLUnpinned, Reason: AliasUnpinnedLegacy}),
		...
		contract(PolicyLock, "5", []string{"5"}, "schemas/v5/policy-lock.schema.json", "policy-lock-v5.schema.json", LegacyPolicyLockV5URL, CurrentSchemaTag, "86838b49f01d254f0d6fc652105304fbd653c12b8f51a32674013d6bfa87c8f9", StateLegacy),
		contract(PolicyLock, "6", []string{"6"}, "schemas/v6/policy-lock.schema.json", "policy-lock.schema.json", PolicyLockURL, CurrentSchemaTag, "111d50c03828e74481b54b9ddd5827f381d923daf4022294370f2c317e25b0b5", StateCurrent),
		contract(PolicyReport, "1", []string{"1"}, "schemas/v1/policy-report.schema.json", "policy-report.schema.json", PolicyReportURL, CurrentSchemaTag, "96cb3ebd87dfd06c904daece64ed40178d5c826c211f3bf101065701e090918a", StateCurrent, misbound("schemas/v1/policy-report.schema.json"), unpinned("schemas/v1/policy-report.schema.json")),
		portableContract(contract(ProofBundle, "1", []string{"1"}, "schemas/v1/proof-bundle.schema.json", "proof-bundle.schema.json", ProofBundleURL, CurrentSchemaTag, "83abb361727ec94993b840b7d6cb1f9a7935692c4282244f2de33b67a6d2fbac", StateCurrent, misbound("schemas/v1/proof-bundle.schema.json"), unpinned("schemas/v1/proof-bundle.schema.json"))),
		contract(ReleaseManifest, "1", []string{"reconc.release/v1"}, "schemas/v1/release-manifest.schema.json", "release-manifest.schema.json", ReleaseManifestURL, CurrentSchemaTag, "dad8261a8464ebfb8b6011a53ac5c6c55afeb65e494565a04ea3d0c13f5831e2", StateCurrent, misbound("schemas/v1/release-manifest.schema.json"), unpinned("schemas/v1/release-manifest.schema.json")),
		contract(RepositoryInstall, "1", []string{"1"}, "schemas/v1/repository-install.schema.json", "repository-install.schema.json", RepositoryInstallURL, CurrentSchemaTag, "6c79dc47b374e83142e95adf10913c6ff2074141c240821a5f26b9a6260cdb04", StateCurrent, misbound("schemas/v1/repository-install.schema.json"), unpinned("schemas/v1/repository-install.schema.json")),
		contract(RepositorySyncPlan, "1", []string{"reconc.repository-sync-plan/v1"}, "schemas/v1/repository-sync-plan.schema.json", "repository-sync-plan-v1.schema.json", DefaultBaseURL+"/repository-sync-plan.schema.json", CurrentSchemaTag, "a194fefd31b436c1410f753d5f1c48f4dd6bef565a5b01ec973f6290ae28acd5", StateLegacy, unpinned("schemas/v1/repository-sync-plan.schema.json")),
		contract(RepositorySyncPlan, "2", []string{"reconc.repository-sync-plan/v1"}, "schemas/v2/repository-sync-plan.schema.json", "repository-sync-plan.schema.json", RepositorySyncPlanURL, CurrentSchemaTag, "9cb0f21e49cb1d2abb8642bf5e01a18f7e8530ab6f0ddffe75b87463e364bbc8", StateCurrent, misbound("schemas/v1/repository-sync-plan.schema.json")),
		contract(RepositorySyncReport, "1", []string{"reconc.repository-sync-report/v1", "reconc.repository-sync-verify/v1"}, "schemas/v1/repository-sync-report.schema.json", "repository-sync-report-v1.schema.json", DefaultBaseURL+"/repository-sync-report.schema.json", CurrentSchemaTag, "917670e92c1d93a30de8b7a51c5bb54d372883a747a87219ad6135581f423016", StateLegacy, unpinned("schemas/v1/repository-sync-report.schema.json")),
		contract(RepositorySyncReport, "2", []string{"reconc.repository-sync-recovery/v1", "reconc.repository-sync-report/v1", "reconc.repository-sync-resolution/v1", "reconc.repository-sync-verify/v1"}, "schemas/v2/repository-sync-report.schema.json", "repository-sync-report.schema.json", RepositorySyncReportURL, CurrentSchemaTag, "26abc83ad42bd0b1ac6b501425f8a2b85533e5fbf9f35d63ec8e710a85cfb550", StateCurrent, misbound("schemas/v1/repository-sync-report.schema.json")),
	}
}
