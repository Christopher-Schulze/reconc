...
func contracts() []Contract {
	return []Contract{
		...
		contract(PolicyConfig, "3", nil, "schemas/v3/policy-config.schema.json", "policy-config.schema.json", PolicyConfigURL, CurrentSchemaTag, "f40e717a7e5a44ca1b649501dddd2f0194b9dbc3e5ff6585dc6724d73f827c55", StateCurrent),
		...
		contract(PolicyLock, "5", []string{"5"}, "schemas/v5/policy-lock.schema.json", "policy-lock.schema.json", PolicyLockURL, CurrentSchemaTag, "745ec27f4c24b9b909ae778edd7a9d0b74d54d14e586d687514f70d4f9293d12", StateCurrent),
