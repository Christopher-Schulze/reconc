...
func contracts() []Contract {
	return []Contract{
		...
		contract(PolicyConfig, "3", nil, "schemas/v3/policy-config.schema.json", "policy-config.schema.json", PolicyConfigURL, CurrentSchemaTag, "a570e56fbf125dcef57c66a1fd9e319b76ed1426bfd50878c48aa50466bca119", StateCurrent),
		...
		contract(PolicyLock, "5", []string{"5"}, "schemas/v5/policy-lock.schema.json", "policy-lock.schema.json", PolicyLockURL, CurrentSchemaTag, "ffc9115de9df3f642e6d1b171cfeb0d82352db86649cd2288ecb9427de2906ca", StateCurrent),
