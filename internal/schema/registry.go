...
func contracts() []Contract {
	return []Contract{
		...
		contract(GlobalLifecycle, "1", []string{"reconc.global-lifecycle/v1"}, "schemas/v1/global-lifecycle.schema.json", "global-lifecycle-v1.schema.json", DefaultBaseURL+"/global-lifecycle.schema.json", PreviousSchemaTag, "cc422e2e78ebaf3ea94dcef15ce09acef4bca0e2bd2e9fe0d130925b1e0bc341", StateLegacy, misbound("schemas/v1/global-lifecycle.schema.json"), unpinned("schemas/v1/global-lifecycle.schema.json")),
		contract(GlobalLifecycle, "2", []string{"reconc.global-lifecycle/v2"}, "schemas/v2/global-lifecycle.schema.json", "global-lifecycle.schema.json", GlobalLifecycleURL, "", "8c55f2688ed7a3ec0869be688b23e674a59f10dedbce037448505ad6c099548e", StateCurrent),
		...
		contract(InstallationReceipt, "1", []string{"1"}, "schemas/v1/installation-receipt.schema.json", "installation-receipt-v1.schema.json", DefaultBaseURL+"/installation-receipt.schema.json", PreviousSchemaTag, "de380599f45e979381cdf9957a611d33b96c6d0ddb0d4fcea35c72e0c98e568c", StateLegacy, misbound("schemas/v1/installation-receipt.schema.json"), unpinned("schemas/v1/installation-receipt.schema.json")),
		contract(InstallationReceipt, "2", []string{"2"}, "schemas/v2/installation-receipt.schema.json", "installation-receipt.schema.json", InstallationReceiptURL, "", "a74d6008da65f00fbcfe5d9ab3610e39f7419417e2fab52cac1071b05769b2d5", StateCurrent),
