...
func contracts() []Contract {
	return []Contract{
		...
		contract(PolicyFixPlan, "2", []string{"2"}, "schemas/v2/policy-fix-plan.schema.json", "policy-fix-plan.schema.json", PolicyFixPlanURL, CurrentSchemaTag, "ffad84066396677bd09f5c8cf5b65d21ff6e969a063bcf2496076bfeede691c5", StateCurrent),
		...
		contract(PolicyLock, "6", []string{"6"}, "schemas/v6/policy-lock.schema.json", "policy-lock.schema.json", PolicyLockURL, CurrentSchemaTag, "bdb8e8550e8582e4dcaa118a20f6d10a74f7708a87f4d3a59255277cf1bb0088", StateCurrent, Alias{URL: PreviousPolicyLockV6URL, Reason: AliasPriorPublication}, Alias{URL: PolicyLockV6URLV097, Reason: AliasPriorPublication}),
