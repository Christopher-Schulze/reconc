...
func contracts() []Contract {
	return []Contract{
		...
		contract(PolicyConfig, "3", nil, "schemas/v3/policy-config.schema.json", "policy-config.schema.json", PolicyConfigURL, CurrentSchemaTag, "b1f374386d3094f23d8bb308ece9a3fd52ee3011b7e48ed199f7e7f2f2186a01", StateCurrent),
		...
		contract(PolicyLock, "5", []string{"5"}, "schemas/v5/policy-lock.schema.json", "policy-lock.schema.json", PolicyLockURL, CurrentSchemaTag, "fc1c57020d84bf0d7902e73f4db414bd91adfb94f491bc493f24a62b3ff0cca0", StateCurrent),
